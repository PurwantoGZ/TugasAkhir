...
namespace OpticalCharacterRecognition
{
    public partial class MainView : MetroForm
    {
        ...
        {
            var convert = new ConvertView();
            convert.SaveAs("Pdf File|*.pdf");
        ...
        private void toolConvert_Click(object sender, EventArgs e)
        {
            var convert = new OCR();
            string result = "";
            convert.ReadTextFromImage(FileNameImage,ref result);
            info_jum_karakter.Text ="Jumlah Karakter: "+ convert.jumlahKarakter(result).ToString()+" karakter.";
            ConvertView convertview = new ConvertView(result);
        ...
        private void enabletool(bool state)
        {
            ...
            info_jum_karakter.Text = "Jumlah karakter: ";
        }
